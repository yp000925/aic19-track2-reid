...
parser.add_argument(
    '--head_name', default='fusion_resnet50', choices=HEAD_CHOICES,
...
parser.add_argument(
    '--batch_p', default=18, type=common.positive_int,
...
parser.add_argument(
    '--lr_decay_steps', default=1000, type=common.positive_int,
    help='Learning rate decay steps')

parser.add_argument(
    '--train_iterations', default=15000, type=common.positive_int,
    help='Number of training iterations.')

parser.add_argument(
    '--decay_start_iteration', default=5000, type=int,
...
parser.add_argument(
    '--checkpoint_frequency', default=500, type=common.nonnegative_int,
...
def main():
    ...
    if args.head_name == 'fusion':
        with tf.name_scope('head'):
            endpoints = head.head(endpoints, args.embedding_dim, args.model_name, is_training=True)
    else:
        with tf.name_scope('head'):
