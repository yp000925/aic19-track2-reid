...
def main():
    ...
    with tf.Session() as sess:
        ...
        layer_name = ['resnet_v1_50/block1', 'resnet_v1_50/block2', 'resnet_v1_50/block3', 'resnet_v1_50/block4']
        feature1,feature2,feature3,feature4 = sess.run([endpoints[layer_name[0]],
        ...
        # for activation, layer_name in zip(features, layer_name):
